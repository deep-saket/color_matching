...
from common import InferenceVLComponent, InferenceImageEmbeddingComponent


class QwenV25Infer(InferenceVLComponent, InferenceImageEmbeddingComponent):
    """
    ...
    def get_image_embedding(self, image: Image.Image, prompt: str = "Describe the hair color.") -> torch.Tensor:
        messages = [
            {
                "role": "user",
                "content": [
        ...
        return outputs.hidden_states[-1][:, -1]  # Return final token embedding
